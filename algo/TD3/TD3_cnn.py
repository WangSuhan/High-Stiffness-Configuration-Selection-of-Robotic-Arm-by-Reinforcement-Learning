...
import copy
from algo.TD3.net_cnn import PolicyNet_CNN, QValueNet_CNN
...
class TD3_CNN:
    ...
    def __init__(self, state_dim, action_dim, action_bound, hidden_dim=opt.hidden_dim,
        ...
        self.actor = PolicyNet_CNN(state_dim,hidden_dim, action_dim, action_bound).to(device)
        self.critic = QValueNet_CNN(state_dim, hidden_dim,action_dim).to(device)
        self.target_actor = PolicyNet_CNN(state_dim,hidden_dim, action_dim, action_bound).to(device)
        self.target_critic = QValueNet_CNN(state_dim,hidden_dim, action_dim).to(device)
